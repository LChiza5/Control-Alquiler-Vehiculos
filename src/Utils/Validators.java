...
public class Validators {
  ...
  public static void noVacio(String s, String campo) throws ReglaDeNegocioException{
    if (s == null || s.trim().isEmpty()) throw new ReglaDeNegocioException("El campo '"+campo+"' es obligatorio.");
  }
  ...
  public static void email(String s) throws ReglaDeNegocioException{
    noVacio(s, "correo");
    if (!EMAIL_RE.matcher(s).matches()) throw new ReglaDeNegocioException("Correo con formato inválido.");
  }
  ...
  public static void inicioNoAntesDeHoy(LocalDate inicio) throws ReglaDeNegocioException{
    ...
    if (inicio.isBefore(LocalDate.now())) throw new ReglaDeNegocioException("La fecha de inicio no puede ser menor a hoy.");
  }
  ...
  public static void finPosterior(LocalDate inicio, LocalDate fin) throws ReglaDeNegocioException{
    ...
    if (!fin.isAfter(inicio)) throw new ReglaDeNegocioException("La fecha de fin debe ser posterior a la de inicio.");
  }
  ...
  public static void duracionMaxima(LocalDate inicio, LocalDate fin, int maxDias) throws ReglaDeNegocioException{
    ...
    if (dias > maxDias) throw new ReglaDeNegocioException("La duración no puede exceder " + maxDias + " días (actual: " + dias + ").");
  }
}
